...
public unsafe interface IOpenGL_4_5
{
    public static IOpenGL_4_5 OpenGL_4_5 => ILibLoader.CreateLoader.Load<IOpenGL_4_5>(
        new(wglGetProcAddress, u => "gl" + u),
        new("opengl32.dll", u => "gl" + u));

    [DllImport("opengl32", CharSet = CharSet.Ansi, ExactSpelling = true)]
